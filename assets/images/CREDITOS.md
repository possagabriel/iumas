# Imagem ilustrativa da abertura

Arquivo: `solar-hero.webp` (1600 × 1065 px, aproximadamente 304 KB).

Foto de **American Public Power Association**, publicada no Unsplash:
...
de saturação, contraste e sobreposição da abertura é aplicado em CSS.

Os SVGs e as fotos de antes/depois já estavam no projeto. Os SVGs receberam apenas
ajustes de apresentação; as fotos originais do comparador foram preservadas integralmente.
